...
import generateGame, { GAMEFIELD, GAMEFIELD_WORDS_CONTAINER, setCurrentRowNumber } from './game-screen';
import { CHECK_BTN, CONTINUE_BTN, fromActiveToInnactiveBtns } from './game-screen-menus/game-buttons/game-buttons';
...
function createChooseLevelContainer() {
  ...
  chooseLevelFormContainer.addEventListener('submit', (event) => {
    ...
    fromActiveToInnactiveBtns(CHECK_BTN, CONTINUE_BTN);
